...
function renderAdminCopyright(customerMap, rows){
  ...
  body.innerHTML=connected.length?connected.map(a=>{
    ...
    return `<tr>
      ...
      <td>${a.channel_id
        ? `<a class="btn primary" href="https://studio.youtube.com/channel/${encodeURIComponent(a.channel_id)}/copyright" target="_blank" rel="noopener">Check Restrictions</a>`
        : `<a class="btn primary" href="https://studio.youtube.com/" target="_blank" rel="noopener">Check Restrictions</a>`}</td>
    </tr>`;
  }).join(""):'<tr><td colspan="4">No connected channels.</td></tr>';
}
